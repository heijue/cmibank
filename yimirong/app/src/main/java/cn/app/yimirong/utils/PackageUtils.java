...
import cn.app.yimirong.utils.ShellUtils.CommandResult;
 ...
 * <li>{@link PackageUtils#isTopActivity(Context, String)} whether the cn.app whost
...
public class PackageUtils {
	...
	public static int installSilent(Context context, String filePath,
		...
		/**
		 * if context is system cn.app, don't need root permission, but should add
	 ...
	 *
	 * @param context
	 * @param packageName package name of cn.app
	 * @return
	 */
	...
	/**
	 * uninstall package and clear data of cn.app silent by root
	 *
	 * @param context
	 * @param packageName package name of cn.app
	 * @return
	 ...
	 * manifest, so no need to request root permission, if you are system cn.app.</li>
	 * </ul>
	 *
	 ...
	 * <li>if package name exit, but not system cn.app, return false</li>
	...
	/**
	 * whether the cn.app whost package's name is packageName is on the top of the
	 * stack
	 * <ul>
	 * <strong>Attentions:</strong>
	 ...
	 * retun whether the cn.app is on the top of stack
	 */
	 ...
	 * storage space to install the cn.app.
	 */
