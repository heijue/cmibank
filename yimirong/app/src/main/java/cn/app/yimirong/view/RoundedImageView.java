...
public class RoundedImageView extends ImageView {
	...
	public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius_top_left, -1);
		mCornerRadii[RoundedDrawable.CORNER_TOP_RIGHT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius_top_right, -1);
		mCornerRadii[RoundedDrawable.CORNER_BOTTOM_RIGHT] = a
				.getDimensionPixelSize(
						R.styleable.RoundedImageView_riv_corner_radius_bottom_right,
						-1);
		mCornerRadii[RoundedDrawable.CORNER_BOTTOM_LEFT] = a.getDimensionPixelSize(
		...
		if (drawable instanceof RoundedDrawable) {
			...
			if (mCornerRadii != null) {
				((RoundedDrawable) drawable).setCornerRadius(
						mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT],
						mCornerRadii[RoundedDrawable.CORNER_TOP_RIGHT],
						mCornerRadii[RoundedDrawable.CORNER_BOTTOM_RIGHT],
