...
package cn.app.yimirong.presenter.pay;
...
public class MobileSecurePayer {
	...
	public boolean pay(String strOrderInfo, final Handler callback,
		...
		return pay(strOrderInfo, callback, myWhat, activity, false, isTest);
	 ...
	 * @param myWhat       回调信息
	 * @param activity     目标activity
	 * @param signCard     是否是单独签约
	 * @param isTest       是否是测试环境，true为测试环境，但不推荐使用。
	 * @return
	 */
	public boolean pay(String strOrderInfo, final Handler callback,
					   final int myWhat, final Activity activity, boolean signCard, boolean isTest) {
		if (mbPaying)
			return false;
		mbPaying = true;
