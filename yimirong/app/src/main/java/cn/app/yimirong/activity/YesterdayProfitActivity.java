...
public class YesterdayProfitActivity extends BaseActivity implements OnRefreshListener {
	...
	private void LoadUserProfit() {
		if (amodel != null) {
			amodel.getUserProfitList(0, type, currentPage, days, new ResponseHandler() {
				@Override
