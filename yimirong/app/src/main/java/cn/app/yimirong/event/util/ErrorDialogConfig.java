...
public class ErrorDialogConfig {
	...
	public ErrorDialogConfig(Resources resources, int defaultTitleId,
							 int defaultMsgId) {
	...
	public ErrorDialogConfig addMapping(Class<? extends Throwable> clazz,
										int msgId) {
	...
	public int getMessageIdForThrowable(final Throwable throwable) {
		...
		if (resId != null) {
			...
			Log.d(EventBus.TAG, "No specific message ressource ID found for "
					+ throwable);
	...
	public void setDefaultEventTypeOnDialogClosed(
			Class<?> defaultEventTypeOnDialogClosed) {
